  ...
  const totalCheckedPurchasePrice = useMemo(
    () =>
      checkedPurchases.reduce(
        (accumulator, currentValue) => accumulator + currentValue.product.price * currentValue.buy_count,
        0
      ),
    [checkedPurchases]
  )
    ...
    () =>
      checkedPurchases.reduce(
        (accumulator, currentValue) =>
          accumulator +
          (currentValue.product.price_before_discount - currentValue.product.price) * currentValue.buy_count,
        0
      ),
    [checkedPurchases]
  )
