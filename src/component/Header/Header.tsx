...
import {} from 'src/assets/images/cart-empty.png'
import { formatCurrency, getAvatarUrl } from 'src/utils/ultils'
              ...
              renderPopover={
                <div className='bg-white relative shadow-md rounded-sm border border-gray-200'>
                  <div className='flex flex-col py-2 px-3'>
                    ...
                    <Link
                      to={path.cart}
                      className='block py-2 px-3 hover:bg-slate-100 bg-white hover:text-cyan-500 text-center'
                    >
                      Đơn Hàng
                    </Link>
                    <button
                ...
                <div className='relative  max-w-[400px] rounded-sm border border-gray-200 bg-white text-sm shadow-md'>
                  {purchasesInCart && purchasesInCart.length > 0 ? (
                    ...
                    <div className='flex h-[300px] w-[300px] flex-col items-center justify-center p-2'>
                      <img src={cartEmpty} alt='no purchase' className='h-24 w-24' />
